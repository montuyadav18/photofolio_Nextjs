...
// Project.jsx (Updated with pure Tailwind classes)
"use client";
...
// Assuming you have Tailwind configured to handle custom classes like 
// 'font-Syne', 'text-warning', 'section-title', 'portfolio-shape', 
// 'contact-form-control', 'btn-primary', and 'contact-social-link'
// OR you have defined them in your global CSS.
// Tailwind equivalents for common classes:
// d-flex -> flex
// flex-wrap -> flex-wrap
// flex-column -> flex-col
// gap-x-4 -> space-x-4
// mb-n6 -> -mb-6 (used on the parent container, converted to negative margin on row)
// col-12 col-lg-6 -> w-full lg:w-1/2
        ...
        <div className="overflow-x-hidden">
            <>
                ...
                <main className="pt-[120px]">
                    ...
                    {/* Contact Section Start (Converted to Tailwind) */}
                    <section className="bg-white pt-20 pb-40"> {/* pb-120 approximated to pb-40 */}
                        <div className="container mx-auto px-4 sm:px-6 lg:px-8">

                            {/* Row wrapper - converted to flex and negative margin */}
                            <div className="flex flex-wrap -mb-6">
                                ...
                                <div className="w-full lg:w-1/2 mb-6" data-aos="fade-up">
                                    <div className="font-bold font-Syne leading-none flex flex-col space-y-2 mb-10">
                                        ...
                                        <h3 className="section-title text-black"> {/* text-dark -> text-black (Tailwind default) */}
                                    ...
                                    <div className="flex flex-col space-y-7"> {/* gap-7 approximated with space-y-7 */}

                                        {/* Email Address Item */}
                                        <div className="flex items-start space-x-4 address-item"> {/* d-flex flex-wrap, converted to flex items-start space-x-4 */}
                                            ...
                                            <div className="flex flex-col flex-1">
                                                <span className="text-base leading-none">Email us</span> {/* paragraph -> text-base */}
                                                <h5 className="text-xl font-bold font-Syne text-black leading-7">hello@henry.com
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start space-x-4 address-item">
                                            ...
                                            <div className="flex flex-col flex-1">
                                                ...
                                                <h5 className="text-xl font-bold font-Syne text-black leading-7">+1 234 567 890 | +1
                                                    234 567 890
                                                </h5>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-start space-x-4 address-item">
                                            ...
                                            <div className="flex flex-col flex-1">
                                                ...
                                                <h5 className="text-xl font-bold font-Syne text-black leading-7">2715 Ash Dr. San
                                ...
                                <div className="w-full lg:w-1/2 mb-6" data-aos="fade-up" data-aos-delay="300">
                                    <form id="contact-form" action="#" method="post" className="flex flex-wrap -mx-3">

                                        {/* Name Input */}
                                        <div className="w-full md:w-1/2 px-3 mb-6"> {/* Added mb-6 for spacing between rows */}
                                            <label className="text-sm font-normal font-Inter leading-tight mb-3 block"
                                                htmlFor="name">Name</label>
                                            <input id="name" className="font-normal w-full leading-7 contact-form-control " type="text"
                                        ...
                                        <div className="w-full md:w-1/2 px-3 mb-6">
                                            ...
                                            <input id="Email" className="font-normal w-full leading-7 contact-form-control " type="email"
                                        ...
                                        <div className="w-full md:w-1/2 px-3 mb-6">
                                            ...
                                            <input id="Phone" className="font-normal w-full leading-7 contact-form-control " type="text"
                                        ...
                                        <div className="w-full md:w-1/2 px-3 mb-6">
                                            ...
                                            <input id="Subject" className="font-normal w-full leading-7 contact-form-control " type="text"
                                        ...
                                        <div className="w-full px-3 mb-6">
                                            ...
                                            <textarea className="font-normal w-full contact-form-control resize-none" name="message"
                                                id="Message" cols={30} rows={10} placeholder="Type your message"></textarea>
                                        </div>

                                        {/* Submit Button */}
                                        <div className="w-full px-3">
                                            <button className="flex d-flex items-center justify-center btn-primary" type="submit">
                                                Submit
                                                <span className="inline-block ml-3 animate-arrow-up">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                        xmlns="http://www.w3.org/2000/svg">
                                                        <path d="M7 17L17 7" stroke="currentColor" strokeOpacity="0.9"
                                                            strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                                        <path d="M7 7H17V17" stroke="currentColor" strokeOpacity="0.9"
                                                            strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path>
                                                    </svg>
                                                </span>
                                            </button>
                                        ...
                                        <div className="w-full px-3">
                                            <div
                                                className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6 mt-14">
