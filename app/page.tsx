              ...
              <div className="row">
                <div className="col-12">
                  <div className="hero-content-wrapper">
                    ...
                    <h2
                      className="hero-title font-Syne fw-bold mb-20"
                      data-aos="fade-right"
                      data-aos-delay={600}
                    >
                      Mujawar
                    ...
                    <p
                      className="font-Syne fw-bold text-lg leading-tight iam-designer mb-30"
                      data-aos="fade-right"
                      data-aos-delay={800}
                    >
                      Product Designer | Based in Indian
                    </p>
                      ...
                      >
                        ...
                        <div className="d-flex flex-wrap align-items-center justify-content-center service-icon">
                          <svg
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                          >
                            <g clipPath="url(#clip0_1513_4988)">
                              <path
                ...
                <div className="col-12 col-lg-6 about-grid-space-right">
                  <div className="fw-bold font-Syne leading-none d-flex flex-wrap flex-column gap-y-2">
                    ...
                    <h3 className="section-title circle-shape text-dark position-relative">
                      Sajjat Mujawar, Product Designer
                    </h3>
                    <h4 className="based-in-german-title text-dark">Based in German</h4>
                    ...
                    >
                      <div className="tab-contents">
                        ...
                        <p className="paragraph mb-7">
                          Sajjat Mujawar,{" "}
                          <span className="text-dark">Product Designer</span>, based in
                          German. That is where I come in. A lover of words, a wrangler
                          of copy. Here to create copy that not only reflects who you
              ...
              <div className="row">
                ...
                >
                  <div className="rounded-20 overflow-hidden mb-6">
                    <img src="/images/projects/project1.png" alt="project1" />
                  </div>
                ...
                >
                  <div className="rounded-20 overflow-hidden mb-6">
                    <img src="/images/projects/project2.png" alt="project1" />
                  </div>
                  <div className="d-flex flex-wrap flex-column gap-3">
                    <div className="d-flex flex-wrap gap-2">
                      <a
