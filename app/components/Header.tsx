...
export default function Header() {
    ...
    // Apply white-header bg-white if NOT home page
    const addWhiteHeader = pathname !== "/";
        ...
        <>
            ...
            <header
                ...
                className={classNames(
                    "header position-absolute left-0 top-0 w-100 z-3",
                    {
                        "white-header bg-white": addWhiteHeader,
                    }
                )}
            >
                <div className="d-flex justify-content-between header-inner">
                    <div className="header-border-bottom d-flex align-items-center justify-content-between flex-grow-1">
                        ...
                        <Link
                            href="/contact"
                            className={`d-flex align-items-center flex-wrap fw-bold lh-1 contact-link ${isHome ? "hover-text-white text-dark" : "hover-text-orange text-dark"
                                }`}
                        >
                            Let&apos;s Talk
                    ...
                    <button
                        id="offcanvas-toggle"
                        className="bg-dark border-0 offcanvas-toggle"
            ...
            <div
                id="offcanvas"
                className="offcanvas offcanvas-end bg-dark d-flex flex-wrap flex-column justify-content-between"
                tabIndex={-1}
            ...
            >
                <div>
                    ...
                    <div className="d-flex flex-wrap justify-content-between align-items-center offcanvas-header">
                        ...
                        <button
                            id="offcanvas-close"
                            className="offcanvas-close bg-primary border-0"
                    ...
                    <nav className="offcanvas-nav d-flex flex-wrap flex-column justify-content-between">
                        <ul className="offcanvas-menu p-0 list-unstyled">
                            <li className="offcanvas-menu-item">
                                <Link
                                    href="/"
                                    className="text-white text-xl fw-bold font-Syne leading-none d-flex flex-wrap align-items-center justify-content-between offcanvas-menu-link"
                                >
                                    Home
                ...
                {/* Social Links (Kept as raw <a> tags since the href is just '#') */}
                <nav className="pb-10">
